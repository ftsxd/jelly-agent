...
export const api = {
  ...
  codeProjects: () => jget('/api/code-projects'),
  saveCodeProject: (p) => jpost('/api/code-projects', p),
  deleteCodeProject: (id) => jdelete(`/api/code-projects/${encodeURIComponent(id)}`),
  syncCodeProject: (id) => jpost(`/api/code-projects/${encodeURIComponent(id)}/sync`, {}),
  checkCodeProjectUpdate: (id) => jpost(`/api/code-projects/${encodeURIComponent(id)}/check-update`, {}),
  setCodeProjectAnnotation: (id, path, info) => jput(`/api/code-projects/${encodeURIComponent(id)}/annotations`, { path, info }),
  resolveCodeProjectDrafts: (id, body) => jpost(`/api/code-projects/${encodeURIComponent(id)}/drafts`, body),
  annotateCodeProject: (id) => jpost(`/api/code-projects/${encodeURIComponent(id)}/annotate`, {}),
  grantCodeProject: (id, grants) => jput(`/api/code-projects/${encodeURIComponent(id)}/grants`, { grants }),
  approveCodeProjectSync: (id) => jpost(`/api/code-projects/${encodeURIComponent(id)}/sync-request`, {}),
  rejectCodeProjectSync: (id) => jdelete(`/api/code-projects/${encodeURIComponent(id)}/sync-request`),
  ...
  setAgentVars: (name, vars) => jpost(`/api/agents/${encodeURIComponent(name)}/vars`, { vars }),
  deleteAgentVar: (name, key) => jdelete(`/api/agents/${encodeURIComponent(name)}/vars/${encodeURIComponent(key)}`),
