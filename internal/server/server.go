...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/code-projects", s.handleCodeProjects)
	mux.HandleFunc("POST /api/code-projects", s.handleSaveCodeProject)
	mux.HandleFunc("DELETE /api/code-projects/{id}", s.handleDeleteCodeProject)
	mux.HandleFunc("PUT /api/code-projects/{id}/grants", s.handleCodeProjectGrants)
	mux.HandleFunc("POST /api/code-projects/{id}/sync", s.handleSyncCodeProject)
	mux.HandleFunc("POST /api/code-projects/{id}/check-update", s.handleCheckCodeProjectUpdate)
	...
	mux.HandleFunc("POST /api/agents/{name}/vars", s.handleSetAgentVars)
	mux.HandleFunc("DELETE /api/agents/{name}/vars/{key}", s.handleDeleteAgentVar)
